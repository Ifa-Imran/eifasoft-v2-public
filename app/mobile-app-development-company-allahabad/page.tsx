...
export async function generateMetadata(): Promise<Metadata> {
  return genMeta({
    title: 'Mobile App Development Company Allahabad | iOS & Android Apps | EifaSoft',
    description: 'Professional mobile app development company in Allahabad offering iOS, Android, React Native, Flutter apps. 500+ apps delivered. Educational apps, tourism apps, business solutions. Starting ₹50,000!',
    canonical: '/mobile-app-development-company-allahabad',
    keywords: [
      'mobile app development allahabad',
      'ios app development allahabad',
      'android app allahabad',
      'allahabad app developers',
      'flutter apps allahabad',
      'education app allahabad',
      'prayagraj app development',
      'react native app allahabad',
      'tourism app allahabad',
      'iit app development allahabad',
      'ecommerce app allahabad',
      'business app allahabad',
      'custom mobile app allahabad',
      'affordable app development allahabad',
      'best app developer allahabad',
      'app development company allahabad',
      'app development prayagraj',
      'heritage site app allahabad',
      'religious tourism app prayagraj',
      'app developer civil lines allahabad',
      'university app allahabad',
      'coaching app allahabad'
    ],
  });
}
...
const faqs = [
  {
    question: 'Why choose EifaSoft for mobile app development in Allahabad?',
    answer: 'EifaSoft has 15+ years of experience delivering mobile apps in Allahabad. We have built 500+ apps including educational apps for IIT/universities, tourism apps for heritage sites, and business apps for local enterprises. We understand Allahabad market (education, tourism, local businesses), provide on-site consultations in Civil Lines, Naini, competitive pricing starting at ₹50,000, and post-launch support. Perfect for Allahabad educational institutions, tourism businesses, and startups.',
  },
  {
    question: 'Do you develop educational and e-learning apps for Allahabad universities?',
    answer: 'Yes! We specialize in educational apps: University Apps - Student portals, Course management, Attendance tracking, Result systems; E-Learning Apps - Video lectures, Quiz modules, Progress tracking, Certifications; Coaching Apps - Live classes, Study materials, Test series, Performance analytics; Features - Offline mode, Multi-language, Push notifications, Payment integration. Perfect for Allahabad University, IIIT, coaching institutes. Starting from ₹80,000.',
  },
  {
    question: 'What platforms do you develop mobile apps for?',
    answer: 'We develop mobile applications for iOS (iPhone/iPad), Android, and cross-platform solutions using React Native and Flutter. We can also develop hybrid apps using web technologies.',
  },
  {
    question: 'What is the cost of mobile app development in Allahabad?',
    answer: 'Mobile app pricing in Allahabad: Basic App: ₹50,000 - ₹1,00,000, Educational App: ₹80,000 - ₹2,50,000, Tourism App: ₹1,00,000 - ₹3,00,000, E-Commerce App: ₹1,50,000 - ₹4,00,000, Enterprise App: ₹3,00,000+. All packages include iOS & Android, UI/UX design, API integration, app store deployment, and 3-month support.',
  },
  {
    question: 'How long does it take to develop a mobile app?',
    answer: 'Development timeline: Basic App: 6-8 weeks, Educational App: 10-14 weeks, Tourism App: 12-16 weeks, Enterprise App: 16-24 weeks. We provide weekly updates, milestone delivery, on-site meetings in Allahabad. Rush delivery available.',
  },
  {
...
export default function MobileAppDevelopmentAllahabadPage() {
  const serviceSchema = generateServiceSchema(
    'Mobile App Development Company Allahabad',
    'Professional iOS, Android, and cross-platform mobile app development in Allahabad. Educational apps, tourism apps, and business solutions.',
    'Allahabad'
  );
  ...
  const productSchema = generateProductSchema(
    'Mobile App Development Package Allahabad',
    'Complete mobile app development for Allahabad businesses. Educational apps, tourism solutions, business apps for iOS & Android',
    '50000'
  );
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Allahabad Mobile App Development', url: '/mobile-app-development-company-allahabad' },
  ]);
  ...
  return (
    <main className="min-h-screen">
      ...
      <Hero
        title="Mobile App Development Company in Allahabad"
        subtitle="Educational Apps | Tourism Apps | Business Solutions"
        description="Leading mobile app development in Allahabad. Educational apps for universities, tourism apps for heritage sites, business solutions. 500+ apps delivered. Starting ₹50,000!"
        gradient="purple"
      />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Local Coverage Across Allahabad</h2>
          <p className="text-lg text-gray-600">Serving businesses and institutions across Allahabad (Prayagraj) and nearby UP cities</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="font-bold text-gray-900 mb-3">Allahabad Areas</h3>
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>• On-site meetings in Allahabad</li>
        ...
        <div className="mt-10 flex flex-wrap gap-3 justify-center">
          {[
            'Mobile App Allahabad', 'Educational App IIT Allahabad', 'Tourism App Prayagraj',
            'University App Allahabad', 'Android App Allahabad', 'iOS App Allahabad',
            'App Developer Civil Lines', 'E-Commerce App Allahabad', 'React Native Allahabad',
            'Flutter App Prayagraj', 'Business App Allahabad', 'App Development Varanasi'
          ].map((tag) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <ContactForm serviceName="Mobile App Development" cityName="Allahabad" />
          </div>
        </div>
      </section>
    </main>
