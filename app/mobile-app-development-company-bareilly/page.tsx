...
export async function generateMetadata(): Promise<Metadata> {
  return genMeta({
    title: 'Mobile App Development Company Bareilly | iOS & Android Apps | EifaSoft',
    description: 'Professional mobile app development company in Bareilly offering iOS, Android, furniture industry apps, trading apps, business solutions. 500+ apps delivered. Furniture capital expertise. Starting ₹50,000!',
    canonical: '/mobile-app-development-company-bareilly',
    keywords: [
      'mobile app development bareilly',
      'ios app development bareilly',
      'android app bareilly',
      'furniture app bareilly',
      'trading app bareilly',
      'bareilly app developers',
      'react native app bareilly',
      'flutter app development bareilly',
      'b2b trading app bareilly',
      'ecommerce app bareilly',
      'business app bareilly',
      'custom mobile app bareilly',
      'affordable app development bareilly',
      'best app developer bareilly',
      'app development company bareilly',
      'rohilkhand app development',
      'wholesale app bareilly',
      'inventory app bareilly',
      'app development pilibhit',
      'zardozi app bareilly',
      'furniture catalog app bareilly',
      'app developer civil lines bareilly'
    ],
  });
}
...
const faqs = [
  {
    question: 'Why choose EifaSoft for mobile app development in Bareilly?',
    answer: 'EifaSoft has 15+ years of experience delivering mobile apps in Bareilly. We have built 500+ apps including furniture catalog apps, B2B trading apps, inventory management apps, and e-commerce solutions. We understand Bareilly market (furniture manufacturing, trading, retail), provide on-site consultations in Civil Lines, Pilibhit Bypass, competitive pricing starting at ₹50,000, and dedicated support. Perfect for Bareilly furniture manufacturers, traders, and businesses.',
  },
  {
    question: 'Can you develop apps for the furniture manufacturing industry in Bareilly?',
    answer: 'Yes! Bareilly is famous for furniture. We develop: Manufacturer Apps - Product catalogs with 3D views, Wholesale ordering, B2B portals, Custom design uploads; Dealer Apps - Inventory management, Order tracking, Price lists, Customer relationship; E-Commerce Apps - Online furniture stores, AR preview, Payment gateway, Delivery tracking; Features - High-quality images, Measurement tools, Material specifications. Starting from ₹1,20,000.',
  },
  {
    question: 'Do you create trading and wholesale apps for Bareilly businesses?',
    answer: 'Absolutely! We specialize in B2B trading apps: Features - Product catalogs, Bulk ordering, Price negotiations, Order management, Payment tracking, Inventory sync, Supplier management, Multi-location support; Perfect for Bareilly wholesale traders, distributors, and suppliers across furniture, textiles, and agricultural products. Starting from ₹1,00,000.',
  },
  {
    question: 'What is the cost of mobile app development in Bareilly?',
    answer: 'Mobile app pricing in Bareilly: Basic App: ₹50,000 - ₹1,00,000, Furniture Catalog App: ₹1,20,000 - ₹3,00,000, Trading/B2B App: ₹1,00,000 - ₹2,50,000, E-Commerce App: ₹1,50,000 - ₹4,00,000, Enterprise App: ₹3,00,000+. All packages include iOS & Android, UI/UX design, API integration, app store deployment, and 3-month support.',
  },
  {
    question: 'How long does it take to develop a mobile app?',
    answer: 'Development timeline: Basic App: 6-8 weeks, Furniture Catalog App: 10-14 weeks, B2B Trading App: 12-16 weeks, Enterprise App: 16-24 weeks. We provide weekly updates, milestone delivery, on-site meetings in Bareilly. Rush delivery available.',
  },
  {
...
export default function MobileAppDevelopmentBareillyPage() {
  const serviceSchema = generateServiceSchema(
    'Mobile App Development Company Bareilly',
    'Professional iOS, Android, and cross-platform mobile app development in Bareilly. Furniture apps, trading apps, business solutions.',
    'Bareilly'
  );

  const localBusinessSchema = {
    ...generateLocalBusinessSchema('Bareilly'),
    geo: {
      '@type': 'GeoCoordinates',
      latitude: 28.3670,
      longitude: 79.4304,
  ...
  const productSchema = generateProductSchema(
    'Mobile App Development Package Bareilly',
    'Complete mobile app development for Bareilly businesses. Furniture catalog apps, B2B trading solutions, wholesale apps for iOS & Android',
    '50000'
  );
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Bareilly Mobile App Development', url: '/mobile-app-development-company-bareilly' },
  ]);
  ...
  return (
    <main className="min-h-screen">
      ...
      <Hero
        title="Mobile App Development Company in Bareilly"
        subtitle="Furniture Apps | Trading Apps | B2B Solutions"
        description="Leading mobile app development in Bareilly. Furniture catalog apps, B2B trading platforms, wholesale solutions. 500+ apps delivered. Starting ₹50,000!"
        gradient="purple"
      />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Local Coverage Across Bareilly</h2>
          <p className="text-lg text-gray-600">Serving businesses across Bareilly and nearby Rohilkhand region cities</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>• On-site meetings in Bareilly</li>
        ...
        <div className="mt-10 flex flex-wrap gap-3 justify-center">
          {[
            'Mobile App Bareilly', 'Furniture Catalog App Bareilly', 'B2B Trading App Bareilly',
            'Wholesale App Bareilly', 'Android App Bareilly', 'iOS App Bareilly',
            'App Developer Civil Lines Bareilly', 'E-Commerce App Bareilly', 'React Native Bareilly',
            'Flutter App Bareilly', 'Rohilkhand App Development', 'App Development Rampur'
          ].map((tag) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <ContactForm serviceName="Mobile App Development" cityName="Bareilly" />
          </div>
        </div>
      </section>
    </main>
