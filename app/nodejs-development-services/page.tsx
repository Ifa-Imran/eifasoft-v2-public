...
export async function generateMetadata(): Promise<Metadata> {
  return genMeta({
    title: 'Node.js Development Services India | Backend API & Real-time Apps | EifaSoft',
    description: 'Expert Node.js development company in India. Custom backend APIs, real-time applications, microservices, enterprise solutions with Express.js, NestJS. Starting ₹1,00,000.',
    canonical: '/nodejs-development-services',
    keywords: [
...
export default function NodeJSDvelopmentServices() {
  const services = [
    {
      icon: '🔌',
      title: 'Custom Node.js Development',
      description: 'Tailored Node.js solutions built from ground up for your specific business needs',
      features: ['RESTful APIs', 'GraphQL APIs', 'Microservices', 'Real-time Features'],
    },
    {
      icon: '⚡',
      title: 'Express.js Development',
      description: 'Fast, minimalist web applications and APIs using the most popular Node.js framework',
      features: ['REST APIs', 'Middleware Development', 'Route Management', 'Integration Services'],
    },
    {
      icon: '🏗️',
      title: 'NestJS Enterprise Solutions',
      description: 'Scalable, maintainable enterprise applications with Angular-inspired architecture',
      features: ['TypeScript Support', 'Dependency Injection', 'Module System', 'Testing Framework'],
    },
    {
      icon: '💬',
      title: 'Real-time Applications',
      description: 'Live chat, collaboration tools, and real-time data streaming with Socket.io',
      features: ['WebSocket', 'Socket.io', 'Pub/Sub', 'Live Updates'],
    },
    {
      icon: '☁️',
      title: 'Cloud-Native Development',
      description: 'Serverless functions, auto-scaling, and cloud-optimized architectures',
      features: ['AWS Lambda', 'Azure Functions', 'Docker', 'Kubernetes'],
    },
    {
      icon: '🔄',
      title: 'Migration Services',
      description: 'Legacy application migration to modern Node.js architecture',
      features: ['PHP to Node.js', 'Python to Node.js', 'Monolith to Microservices', 'Zero Downtime'],
    },
  ];
  ...
  const technologies = [
    ...
    { name: 'Koa.js', icon: '🌿', category: 'Framework' },
    ...
    { name: 'Mongoose', icon: '📦', category: 'ODM' },
    { name: 'Sequelize', icon: '🔷', category: 'ORM' },
    { name: 'Prisma', icon: '⚙️', category: 'ORM' },
    { name: 'Docker', icon: '🐳', category: 'DevOps' },
    { name: 'Kubernetes', icon: '☸️', category: 'Orchestration' },
    { name: 'AWS Lambda', icon: 'λ', category: 'Serverless' },
    { name: 'PM2', icon: '🔄', category: 'Process Manager' },
  ];
  ...
  const pricingPlans = [
    ...
    {
      name: 'Enterprise Node.js Solution',
      price: '₹5,00,000+',
  ...
  const serviceSchema = generateServiceSchema(
    ...
    'Professional Node.js development company in India offering custom backend APIs, real-time applications, microservices, enterprise solutions with Express.js, NestJS, Socket.io, MongoDB, PostgreSQL.'
  );

  const productSchema = generateProductSchema(
    'Node.js Development Package',
    'Complete Node.js development solution with Express.js/NestJS frameworks, RESTful/GraphQL APIs, real-time features, database integration, and cloud deployment for web and mobile applications.',
    '100000'
  );

  const softwareSchema = generateSoftwareApplicationSchema({
    name: 'EifaSoft Node.js Development Platform',
    description: 'Professional Node.js development platform with Express.js, NestJS, Fastify frameworks, real-time capabilities, microservices architecture, database integration (MongoDB, PostgreSQL), and cloud-native deployment.',
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Home', url: '/' },
    { name: 'Node.js Development Services', url: '/nodejs-development-services' },
  ]);
  ...
  return (
    <main className="min-h-screen">
      ...
      <Hero
        ...
        subtitle="Backend APIs & Real-time Applications"
        description="Expert Node.js development company in India. Build scalable backend APIs, real-time applications, microservices, and enterprise solutions with Express.js, NestJS, Socket.io. Starting ₹1,00,000."
        ctaPrimary={{ text: 'Get Started', href: '/contact' }}
        ctaSecondary={{ text: 'View Pricing', href: '/contact' }}
        gradient="green"
      />

      {/* What is Node.js Development - AI Overview Optimization */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="definition-box bg-white rounded-lg p-6 shadow-sm border-l-4 border-green-500">
              <h2 className="text-xl font-bold text-gray-900 mb-3">What is Node.js Development?</h2>
              <p className="text-gray-700 leading-relaxed">
                <strong>Node.js Development</strong> involves building server-side applications using JavaScript runtime built on Chrome&apos;s V8 engine. Node.js enables event-driven, non-blocking I/O architecture perfect for real-time applications, APIs, and microservices. Developers use frameworks like Express.js, NestJS, Fastify with databases (MongoDB, PostgreSQL) to build scalable backend systems, chat applications, streaming platforms, and enterprise solutions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Node.js Development Services</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Node.js Technologies We Use</h2>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Node.js Development Features</h2>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Streamlined workflow for quality Node.js application delivery</p>
          </div>
          <div className="max-w-4xl mx-auto">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Node.js Development Pricing</h2>
      ...
      <section id="contact" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <ContactForm serviceName="Node.js Development" />
        </div>
      </section>
    </main>
  );
